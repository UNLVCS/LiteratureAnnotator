...
def train_t5_with_deepspeed(
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        # Save model checkpoint on all ranks (required for ZeRO stage 3)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, 
        default='/home/tadesa1/research/ADBM/data/tagged_articles/converted_from_bioc.json',
        help=f'{BOLD}Input text file for training{RESET}')

    parser.add_argument('--save_path', type=str, default='/home/tadesa1/research/ADBM/t5_selfsuper_finetune/checkpoints_and_metrics',
